/* Aranya Ceylon — Gift Sets dataset.
   Curated bundles of spices drawn from the CATALOG range. Each set carries colour fields
   (lead spice) so SpicePhoto / GiftBox / cart thumbnails work, and a 100g-equivalent price
   in both markets. `contents` reference CATALOG product names; the page computes an à-la-carte
   comparison (at the stated jar size) to show the saving. Plain JS — load before the React files. */
window.GIFTS = [
  {
